...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-orange-400 text-base-content mt-20">
                <div>
                ...
                <div>
                    ...
                    <div className="grid grid-flow-col gap-4">
                        <a href="https://twitter.com/Tamzid_Monir" target="blank">
                        ...
                        <a href="https://www.facebook.com/tamzid.ull.monir512" target="blank">
